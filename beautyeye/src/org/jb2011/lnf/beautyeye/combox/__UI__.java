 ...
 */
package org.jb2011.lnf.beautyeye.combox;
...
public class __UI__ extends UI {
    ...
    public static void uiImpl() {
        ...
        putBorder("ComboBox.scrollPaneBorder", 2, 0, 4, 0);

        // 不能设置alpha通道小于255的透明颜色，否则会出现无法重paint的问题
        put("ComboBox.background", Color.white);
...
//	put("ComboBox.buttonBackground", BeautyEyeLNFHelper.commonBackgroundColor);
        ...
        putInsets("ComboBox.padding", 1, 0, 1, 0);//5,8,5,8));
        ...
        //用于修正下拉框的弹出窗的X坐标
        put("ComboBox.popupOffsetX", -3);
        /* ~~注：这个属性是Jack Jiang为了更好的ui效果和方便未来的设定自已加的属性 */
        //用于修正下拉框的弹出窗的Y坐标
        put("ComboBox.popupOffsetY", 2);
    }
}
