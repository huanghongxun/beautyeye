...
//		UIManager.put("PopupMenu.border",new BorderUIResource(BorderFactory.createEmptyBorder(20,10,20,10)));//	
		...
		UIManager.put("CheckBoxMenuItem.checkIcon",new org.jb2011.lnf.beautyeye.menu.BECheckBoxMenuItemUI.CheckBoxMenuItemIcon());//javax.swing.plaf.basic.BasicIconFactory.CheckBoxMenuItemIcon);
		//单选按钮式的菜单项选中与否的图标实现设定
		UIManager.put("RadioButtonMenuItem.checkIcon",new org.jb2011.lnf.beautyeye.menu.BERadioButtonMenuItemUI.RadioButtonMenuItemIcon());
		...
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> UI实现类设置 START
		UIManager.put("MenuBarUI",org.jb2011.lnf.beautyeye.menu.BEMenuBarUI.class.getName());
		UIManager.put("MenuUI",org.jb2011.lnf.beautyeye.menu.BEMenuUI.class.getName());
		UIManager.put("MenuItemUI",org.jb2011.lnf.beautyeye.menu.BEMenuItemUI.class.getName());
		UIManager.put("RadioButtonMenuItemUI",org.jb2011.lnf.beautyeye.menu.BERadioButtonMenuItemUI.class.getName());
		UIManager.put("CheckBoxMenuItemUI",org.jb2011.lnf.beautyeye.menu.BECheckBoxMenuItemUI.class.getName());
		UIManager.put("PopupMenuSeparatorUI",org.jb2011.lnf.beautyeye.menu.BEPopupMenuSeparatorUI.class.getName());
		UIManager.put("PopupMenuUI",org.jb2011.lnf.beautyeye.menu.BEPopupMenuUI.class.getName());
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> UI实现类设置 END
	}
}
