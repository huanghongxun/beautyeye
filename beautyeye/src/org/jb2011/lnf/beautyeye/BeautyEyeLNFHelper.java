...
public class BeautyEyeLNFHelper {
    ...
    protected static void implLNF() {
        //自定义窗口的L&F实现
        org.jb2011.lnf.beautyeye.titlepane.__UI__.uiImpl();
        //自定义JTabbedPane的L&F实现
        org.jb2011.lnf.beautyeye.tab.__UI__.uiImpl();
        //自定义按钮的L&F实现
        org.jb2011.lnf.beautyeye.button.__UI__.uiImpl();
        //各种杂七杂八的设置
        org.jb2011.lnf.beautyeye.separator.__UI__.uiImpl();
        //自定义滚动条的L&F实现
        org.jb2011.lnf.beautyeye.scroll.__UI__.uiImpl();
        //自定义表格头的L&F实现
        org.jb2011.lnf.beautyeye.table.__UI__.uiImpl();
        //自定义文本组件的L&F实现
        org.jb2011.lnf.beautyeye.textcoms.__UI__.uiImpl();
        //自定义弹出组件（包括toolTip组件和弹出菜单等）的L&F实现
        org.jb2011.lnf.beautyeye.popup.__UI__.uiImpl();
        //自定义ToggleButton的L&F实现
        org.jb2011.lnf.beautyeye.toolbar.__UI__.uiImpl();
        //自定义菜单项的L&F实现
        org.jb2011.lnf.beautyeye.menu.__UI__.uiImpl();
        //自定义DesktopPane及内部窗体的L&F实现
        org.jb2011.lnf.beautyeye.internalframe.__UI__.uiImpl();
        //自定义进度条的L&F实现
        org.jb2011.lnf.beautyeye.progress.__UI__.uiImpl();
        //自定义单选按钮的L&F实现
        org.jb2011.lnf.beautyeye.radio$cb_btn.__UI__.uiImpl();
        //自定义下拉框的L&F实现
        org.jb2011.lnf.beautyeye.combox.__UI__.uiImpl();
        //自定义JSlider的L&F实现
        org.jb2011.lnf.beautyeye.slider.__UI__.uiImpl();
        //自定义Jtree的L&F实现
        org.jb2011.lnf.beautyeye.tree.__UI__.uiImpl();
        //自定义JSplitPane的L&F实现
        org.jb2011.lnf.beautyeye.split.__UI__.uiImpl();
        //自定义JSpinner的L&F实现
        org.jb2011.lnf.beautyeye.spinner.__UI__.uiImpl();
        //自定义JList的L&F实现
        org.jb2011.lnf.beautyeye.list.__UI__.uiImpl();
        //自定义JFileChooser的L&F实现
        org.jb2011.lnf.beautyeye.filechooser.__UI__.uiImpl();
    }
