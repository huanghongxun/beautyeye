 ...
 */
package org.jb2011.lnf.beautyeye.scroll;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> JScrollPane的相关ui值设定
		UIManager.put("ScrollPane.border",new BorderUIResource(new org.jb2011.lnf.beautyeye.scroll.ScrollPaneBorder()));//BorderFactory.createEmptyBorder(0, 0, 0, 0)));
		...
		UIManager.put("ScrollPaneUI",org.jb2011.lnf.beautyeye.scroll.BEScrollPaneUI.class.getName());
		...
		UIManager.put("ScrollBarUI",org.jb2011.lnf.beautyeye.scroll.BEScrollBarUI.class.getName());
