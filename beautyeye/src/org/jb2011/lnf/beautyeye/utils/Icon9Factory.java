...
public class Icon9Factory extends RawCache<NinePatch> {
    ...
    private void init() {
        ...
        put("tab", "selected", "t1");
        put("tab", "normal", "t2");
        put("tab", "normal_rollover", "tab_rover1");
        ...
        put("button", "green", "btn_special_default");
        put("button", "light_blue", "btn_special_lightblue");
        put("button", "red", "btn_special_red");
        put("button", "blue", "btn_special_blue");
